...
static	COLUMN_HEADINGS	ColumnArray [] = 
{
	...
	{ "DATE",		"",			INIT_STRING_CENTER },
	{ "FAST AVG",	"",			INIT_DOUBLE_RIGHT },
	{ "SLOW AVG",	"",			INIT_DOUBLE_RIGHT },
	{ "CROSS-CLOSE","",			INIT_DOUBLE_RIGHT },
	{ "LAST-CLOSE",	"",			INIT_DOUBLE_RIGHT },
...
#define		MAXTOKS		10
	...
	{
		case 'B':
			ReportOptions.Title = "MA CROSSOVER - BUY SIGNAL";
			break;
		case 'S':
			ReportOptions.Title = "MA CROSSOVER - SELL SIGNAL";
			break;
		case 'A':
			ReportOptions.Title = "MA CROSSOVER - BUYS AND SELLS";
			break;
	}
	...
	sprintf ( ReportOptions.OutputFilename,  "%s/%s_%d", TEMPDIR, "macross", getpid() );
