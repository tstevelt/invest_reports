...
static	COLUMN_HEADINGS	ColumnArray [] = 
{
	...
	{ "AVG PRICE PREV",	"",		INIT_DOUBLE_RIGHT },
	{ "AVG PRICE CURR",	"",		INIT_DOUBLE_RIGHT },
	{ "PERCENT",		"",		INIT_DOUBLE_RIGHT },
	{ "AVG VOL PREV",	"",		INIT_LONG_RIGHT },
	{ "AVG VOL CURR",	"",		INIT_LONG_RIGHT },
	{ "PERCENT",		"",		INIT_DOUBLE_RIGHT }
};
...
#define		MAXTOKS		10
	...
	ReportOptions.Title = "INCREASING VOLUME SCREENER";
	...
	sprintf ( ReportOptions.OutputFilename,  "%s/volume_increase_%d", TEMPDIR, getpid() );
