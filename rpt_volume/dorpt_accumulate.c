...
static	COLUMN_HEADINGS	ColumnArray [] = 
{
	...
	{ "AVG UP VOLUME",	"",		INIT_LONG_RIGHT },
	{ "AVG DOWN VOLUME","",		INIT_LONG_RIGHT },
...
#define		MAXTOKS		10
	...
	ReportOptions.Title = "ACCUMULATE/DISTRIBUTE VOLUME SCREENER";
	...
	sprintf ( ReportOptions.OutputFilename,  "%s/volume_accumulate_%d", TEMPDIR, getpid() );
