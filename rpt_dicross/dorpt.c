...
{
	{ "ACTION",		"",			INIT_STRING_LEFT },
	{ "TICKER",		"",			INIT_STRING_LEFT },
	{ "SHARES",		"",			INIT_LONG_RIGHT },
	{ "PRICE",		"",			INIT_DOUBLE_RIGHT },
	{ "EXTENDED",	"",			INIT_DOUBLE_RIGHT_TOTAL },
...
#define		MAXTOKS		10
	...
	ReportOptions.Title = "DI CROSSOVER";
	...
	sprintf ( ReportOptions.OutputFilename,  "%s/%s_%d", TEMPDIR, "dicross", getpid() );
