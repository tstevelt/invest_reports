...
#include	"rpt_regress.h"
	...
	// printf ( "TICKER     COMPANY                             START    SLOPE   RETURN CorrCoef   StdDev Percent Variance\n" );
	//           x10xxxxxxx x30xxxxxxxxxxxxxxxxxxxxxxxxxxx 8888888.88 99999.99 99999.99 99999.99 99999.99 9999.99 99999.99
...
static	COLUMN_HEADINGS	ColumnArray [] = 
{
	...
	{ "START",		"",		INIT_DOUBLE_RIGHT },
	{ "$/DAY",		"",		INIT_DOUBLE_RIGHT },
	{ "RETURN",		"",		INIT_DOUBLE_RIGHT },
	{ "CORR-COEF",	"",		INIT_DOUBLE_RIGHT },
	{ "STD-DEV",	"",		INIT_DOUBLE_RIGHT },
	{ "S-D PCNT",	"",		INIT_DOUBLE_RIGHT },
	{ "VARIANCE",	"",		INIT_DOUBLE_RIGHT }
};
...
#define		MAXTOKS		100
	...
	ReportOptions.Title = "REGRESSION CHANNEL SCREENER";
	...
	sprintf ( ReportOptions.OutputFilename,  "%s/%s_%d", TEMPDIR, "regress", getpid() );
