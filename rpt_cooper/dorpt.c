...
static	COLUMN_HEADINGS	ColumnArray [] = 
{
	...
	{ "VOLUME",		"",			INIT_DOUBLE_RIGHT },
	{ "ORDER",		"",			INIT_DOUBLE_RIGHT },
	{ "STOP",		"",			INIT_DOUBLE_RIGHT },
	{ "PCNT",		"",			INIT_DOUBLE_RIGHT },
	{ "STRATEGY",	"",			INIT_STRING_LEFT },
};
...
#define		MAXTOKS		11
	...
	ReportOptions.Title = "COOPER HIT AND RUN";
	...
	sprintf ( ReportOptions.OutputFilename,  "%s/%s_%d", TEMPDIR, "cooper", getpid() );
